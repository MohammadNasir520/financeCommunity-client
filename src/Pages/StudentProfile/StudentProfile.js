    ...
    return (
        <div className='min-h-screen'>
            <body class="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"
                ...
                <div class=" flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 mx-8">


                    {/* --Img Col-- */}
                    <div class="w-full lg:w-4/12 px-2 mx-auto">
                        {/* <!-- Big profile image for side bar (desktop) --> */}
                        <img src={student.imageUrl}
                            class="rounded-none w-9/12 h-72 h- lg:rounded-lg shadow-2xl hidden lg:block mx-auto" alt='' />
                        ...
                        <div class=" w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between bg-white py-4 m-4 px-6  opacity-75">
                    ...
                    {/* <!----------------------------------------Main Col--------------------------------------> */}
                    <div id="profile"
                        class="w-full h-4/5 lg:w-8/12 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0">
                        ...
                        <div class="p-4 md:p-12 text-center lg:text-left ">
                            ...
                            {/* ................student name */}
                            <h1 class="text-3xl font-bold pt-8 lg:pt-0">{student.name}</h1>
                            {/* student Email */}
