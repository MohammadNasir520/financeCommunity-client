            ...
            <body className="font-sans antialiased text-gray-900 leading-normal tracking-wider bg-cover"
                ...
                <div className=" flex items-center h-auto lg:h-screen flex-wrap mx-auto my-32 lg:my-0 mx-8">
                    ...
                    <div className="w-full lg:w-4/12 px-2 mx-auto">
                        ...
                        <PhotoView src={student.imageUrl}>

                            <img src={student.imageUrl}
                                style={{}}
                                className="rounded-none w-9/12 h-72 h- lg:rounded-lg shadow-2xl hidden lg:block mx-auto" alt='' />
                        </PhotoView>
                        <div className='text-white my-2'>
                            {student.about ? <>{student.about}</>
                                :
                                <p> {student.name} {student.district && <>from {student.district}</>} </p>
                            }

                        </div>
                        <div className=" w-4/5 lg:w-full mx-auto flex flex-wrap items-center justify-between bg-white py-4 m-4 px-6  opacity-75">

                            <a className="link" href="#" data-tippy-content="@facebook_handle"><svg
                            ...
                            <a className="link" href="#" data-tippy-content="@twitter_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>Twitter</title>
                                <path
                            ...
                            <a className="link" href="#" data-tippy-content="@github_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>GitHub</title>
                                <path
                            ...
                            <a className="link" href="#" data-tippy-content="@unsplash_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                                <title>Unsplash</title>
                                <path d="M7.5 6.75V0h9v6.75h-9zm9 3.75H24V24H0V10.5h7.5v6.75h9V10.5z" />
                            </svg></a>
                            <a className="link" href="#" data-tippy-content="@dribble_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a className="link" href="#" data-tippy-content="@instagram_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img" viewBox="0 0 24 24"
                                xmlns="http://www.w3.org/2000/svg">
                            ...
                            <a className="link" href="#" data-tippy-content="@youtube_handle"><svg
                                className="h-6 fill-current text-gray-600 hover:text-green-700" role="img"
                    ...
                    {/* <!----------------------------------------Main Col--------------------------------------> */}
                    <div id="profile"
                        className="w-full h-4/5 lg:w-8/12 rounded-lg lg:rounded-l-lg lg:rounded-r-none shadow-2xl bg-white opacity-75 lg:mx-0">
                        ...
                        <div className="p-4 md:p-12 text-center lg:text-left ">
                            ...
                            <PhotoView src={student.imageUrl}>
                                ...
                                <img src={student.imageUrl}
                                    ...
                                    className=" h-48 w-48 rounded-full lg:hidden shadow-2xl mx-auto " alt='' />
                            </PhotoView>
                            ...
                            <div >
                                ...
                                <p>Mess/Hall:</p>
                                <p className=' font-semibold '>{student.residence}</p>
                            </div>
                            {/* --------collage------ */}
                            <h2 className='text-lg font-semibold '>Collage</h2>

                            <h6>{student.collage}</h6>



                            {/* --------school------ */}
                            <h2 className='text-lg font-semibold mt-2'>School</h2>
