                    ...
                    <div className="grid grid-cols-1 gap-6 mt-4 sm:grid-cols-2">
                        <div>
                            ...
                            <input
                                ...
                                id="name" type="text" className=" border-none outline-none block w-full px-4 py-2 mt-2 text-gray-700 bg-white border border-gray-300 rounded-md dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 focus:border-blue-500 dark:focus:border-blue-500 focus:outline-none focus:ring" />
                        </div>

                        <div>
                            <label className="text-white dark:text-gray-200" for="emailAddress">Your Email</label>
                            <input
                                onChange={(event) => setStudentInformation({ ...studentInformation, email: event.target.value })}
                        ...
                        <div>
                            ...
                            <input
                                onChange={(event) => setStudentInformation({ ...studentInformation, id: event.target.value })}
